...
```html
<DropdownMenu>
  <DropdownMenuTrigger variant="outline">Align Start</DropdownMenuTrigger>
...
```html
<DropdownMenu>
  <DropdownMenuTrigger variant="outline">Align Center</DropdownMenuTrigger>
...
```html
<DropdownMenu>
  <DropdownMenuTrigger variant="outline">Align End</DropdownMenuTrigger>
...
```html
<DropdownMenu>
  <DropdownMenuTrigger variant="ghost" iconOnly aria-label="More actions">
