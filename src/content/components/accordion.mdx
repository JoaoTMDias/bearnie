  ...
  <AccordionItem value="account">
    <AccordionTrigger>
      <div class="flex flex-col items-start gap-1">
        ...
        <AccordionDescription class="text-sm text-muted-foreground font-normal">
          Manage your account Settings01Icon
...
<Accordion type="single" class="space-y-2">
  ...
  <AccordionItem value="item-2" class="border rounded-lg px-4">
    ...
    <AccordionContent>
      Learn how to customize Settings01Icon to fit your needs.
    </AccordionContent>
  </AccordionItem>
